public class UserTest {
  public static void main(String[] args) {
    ...
    User[] users = new User[5]; //User 자료형 다섯 개를 저장할 수 있는 공간을 생성
    //User 객체 생성 후 배열에 저장
    User user1 = new User(1,"Kim",20);
    User user2 = new User(2,"Lee",25);
    User user3 = new User(3,"Park",32);
    User user4 = new User(4,"Kimura",26);
    User user5 = new User(5,"Tanaka",39);
    users[0] = user1;
    users[1] = user2;
    users[2] = user3;
    users[3] = user4;
    ...
    System.out.println();
    //5. 배열에 저장된 모든 회원 중 나이가 30세를 초과한 회원의
    //    모든 정보를 출력.
    for (int i = 0; i < users.length; i++) {
