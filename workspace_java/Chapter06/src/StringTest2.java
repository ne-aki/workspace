public class StringTest2 {
  public static void main(String[] args) {
    ...
    String rusult1 = String.valueOf(10); //"10"
    String rusult2 = String.valueOf(10.5); //"10.5"

    //substring() : 문자열 일부 추출
    String s4 = "abcdefg";
    String result3 = s4.substring(3); //3번째 index부터 가져오겠다
    System.out.println("result3 = " + result3); //2번째 index부터 5번째 index 전까지!
    String result4 = s4.substring(2,5);
    System.out.println(result4);

    String s5 = "apple,orange,banana";
    String[] result5 = s5.split(","); //s5 문자열을 ,로 분리시킨다.
